...
protected $uploads;             // array of used uploads
...
function Image($file, $x=null, $y=null, $w=0, $h=0, $type='', $link='')
{
	...
	if(!isset($this->uploads[$file]))
	{
		...
		$info = $this->$mtd($file);
		$info['i'] = count($this->uploads)+1;
		$this->uploads[$file] = $info;
	}
	else
...
protected function _putuploads()
{
	foreach(array_keys($this->uploads) as $file)
	{
		$this->_putimage($this->uploads[$file]);
		unset($this->uploads[$file]['data']);
		unset($this->uploads[$file]['smask']);
	}
}
